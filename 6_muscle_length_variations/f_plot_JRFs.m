...
figure_folder = './Figure_scaled_MTU_vs_unscaled';
...
for j = 1:length(JRF_set)
    ...
    for n_antev = 1:length(subj_set)
        ...
        plot(0:100, squeeze(var(:,2)), 'Color',cur_col,'LineWidth',2); hold on
...
%         end
        ...
        % add legend
        if j==2
            legend eTibia Antev40 ScaledMTU 
        end
