...
% ----------------------------------------------------------------------- %
function d_save_mat_summaries()
clear;clc;
fclose all;close all;
addpath(genpath('../../opensim-pipelines/Dynamic_pipeline/Matlab_pipeline_functions'))
%---------------------------------------------------------------------------
% where the simulations are
database_root_folder = '../6_muscle_length_variations\ScaledMuscleParams_sims';

% name of the models used in the simulations
model_set = {'GC5_FemAntev40Deg', 'GC5_FemAntev40Deg_scaled'};
