%-------------------------------------------------------------------------%
% Copyright (c) 2021 Modenese L., Ceseracciu, E., Reggiani M., Lloyd, D.G.%
%                                                                         %
...
% ----------------------------------------------------------------------- %
% This script is taken from the GitHub repository https://github.com/modenaxe/MuscleParamOptimizer
% associated with the publication:
% Modenese, L., Ceseracciu, E., Reggiani, M., & Lloyd, D. G. (2016). 
% Estimation of musculotendon parameters for scaled and subject specific 
% musculoskeletal models using an optimization technique. 
% Journal of biomechanics, 49(2), 141-148.
% ----------------------------------------------------------------------- %
% LINK: https://research-repository.griffith.edu.au/bitstream/handle/10072/101916/ModenesePUB918.pdf
% ----------------------------------------------------------------------- %
